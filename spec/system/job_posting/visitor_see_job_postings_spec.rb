...
describe "Visitor sees job postings", type: :system do
  ...
  it "and cant see inactive job postings" do
    ...
    experience_level = create(:experience_level, name: 'Senior')
    experience_level_1 = create(:experience_level, name: 'Junior')
    create(:job_posting, title: "Dev Rails", description: "Software Developer", company_profile: first_company, experience_level: experience_level_1)
    create(:job_posting, title: "Dev Node", company_profile: second_company, experience_level: experience_level)
