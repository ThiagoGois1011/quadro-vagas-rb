...
JobPosting.create!(title: "Dev Vue", company_profile: CompanyProfile.first, salary: "1000.00", salary_currency: "USD", salary_period: "Monthly", job_type: JobType.first, description: "There’s nothing better than hiking along the rocky footpaths, accompanied only by the noise of cicadas. As the boat docks in the harbor, gaze upon white and blue houses, craggy cliffs, sweeping olive groves, and the dazzling blues of the Aegean sea.", status: :archived)
